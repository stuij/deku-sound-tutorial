...
static void MODPlayNote(u32 channelIdx, u32 note, u32 sample, u32 effect, u32 param);
...
static void MODPlayNote(u32 channelIdx, u32 note, u32 sampleIdx, u32 effect, u32 param)
{
	...
	sndChn->length     = (sample->loopLength != 0 ? 
